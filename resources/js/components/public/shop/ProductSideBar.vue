  ...
  <div class="sidebar left-sidebar">
        ...
        <div class="s-side-text">
            ...
            <div class="size-select clearfix">             
                <a href="#" v-for="size in jsonData.size" :key="size.value" @click.prevent="productFilter(size.value, 'size')">{{size.label}}</a>
            </div>
        </div>
        <div class="s-side-text">
            <div class="sidebar-title clearfix">
            ...
            <div class="brands-select clearfix">
                <ul>
                    <li v-for="(chunk, index) in brands" :key="index">
                        <a href="#" v-for="brand in chunk" :key="brand.id" @click.prevent="productFilter(brand.id, 'brand_id')">{{brand.name}}</a>
                    </li>
                    <!-- <li>
                        <a href="#">Unlimited</a>
                        <a href="#">Shoes</a>
