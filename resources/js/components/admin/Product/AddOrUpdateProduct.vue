                        ...
                        <div class="card">
                            <div class="card-header no-border">
                                <div class="d-flex justify-content-between">
                                    <h3 class="card-title ml-3" v-if="form.id">Update Product</h3>      
                                    <h3 class="card-title ml-3" v-else>Add New Product</h3>                                      
                                </div>   
                            </div>
                            <div class="card-body">
                                <el-form  @submit.prevent ="saveOrUpdateProduct"> 
                                    <el-form-item label="Product Name" class="ml-3">
                                        <el-input v-model="form.name" placeholder="Product Name"></el-input>
                                        <span class="text-danger" v-if="errors['name']">
                                            {{errors['name'][0]}}
                                        </span>
                                    </el-form-item>
                                    <el-form-item label="Select Category" class="ml-3">
                                    ...
                                    <el-form-item label="Select Brand" class="ml-3"> &nbsp; &nbsp; &nbsp;
                                    ...
                                    <el-form-item label="Price" class="ml-3">
                                        <el-input type="number" v-model="form.price" placeholder="Price"></el-input>
                                        <span class="text-danger" v-if="errors['price']">
                                            {{errors['price'][0]}}
                                        </span>
                                    </el-form-item>
                                    <el-form-item label="Discount" class="ml-3">
                                        <el-input type="number" v-model="form.discount_price" placeholder="Discount"></el-input>
                                        <span class="text-danger" v-if="errors['discount_price']">
                                            {{errors['discount_price'][0]}}
                                        </span>
                                    </el-form-item>
                                    <el-form-item label="Product Description" class="ml-3">
                                    ...
                                    <el-form-item label="Product size" class="ml-3">
                                    ...
                                    <el-form-item label="Product Color" class="ml-3">
                                    ...
                                    <el-form-item label="Product Image" class="ml-3">
                                        <input type="file" accept="image/*" @change="handleChange" placeholder="Product Image" class="mr-3">
                                        <img :src="`/uploads/${product.image}`" alt="" width="80px" v-if="form.image">
                                        <span class="text-danger" v-if="errors['image']">
                                            {{errors['image'][0]}}
                                        </span>
                                    </el-form-item>                                 
                                    <el-form-item label="Product Quantity" class="ml-3">
                                        <el-input type="number" v-model="form.quantity" placeholder="Product Description"></el-input>
                                        <span class="text-danger" v-if="errors['quantity']">
                                            {{errors['quantity'][0]}}
                                        </span>
                                    </el-form-item>
                                  <el-button @click.prevent="saveOrUpdateProduct" class="ml-3" type="primary">Submit</el-button>
                                </el-form>
                            </div>
                        </div>
                    </div>
